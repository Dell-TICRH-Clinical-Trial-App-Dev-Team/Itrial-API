...
import { ObjectId, ClientError, CrudModel, UpdateFunctions } from '../utils/utils';
...
export async function update<T>(
  ...
  if (!updateFunctions.has(operation)) throw new ClientError(400, 
